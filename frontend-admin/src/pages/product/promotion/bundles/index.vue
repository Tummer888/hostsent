  ...
  <div class="page-body product-module">
    <header class="page-header surface-card">
      <div class="page-header__main">
        ...
        <div class="page-header__text">
          <h2 class="page-header__title">套餐组合</h2>
          <p class="page-header__desc">管理商品套餐组合促销，配置组合规则与活动有效期。</p>
        </div>
      </div>
      <t-space size="small">
    ...
    <section class="filter-card surface-card">
      ...
      <div class="filter-card__grid">
        <div class="field">
          ...
          <t-input v-model="filters.keyword" placeholder="套餐名称" clearable @enter="handleSearch" />
        </div>
        <div class="field">
    ...
    <section class="table-card surface-card">
      <div class="table-card__head">
        <h3 class="card-title">套餐组合</h3>
        <span class="table-card__meta">共 {{ total }} 个套餐</span>
      </div>
      <t-table
        row-key="id"
        :data="list"
    ...
    >
      <t-form label-align="top" :data="form" @submit.prevent>
        ...
        <t-form-item label="组合规则" name="rule">
          <t-textarea v-model="form.rule" :autosize="{ minRows: 3, maxRows: 6 }" placeholder="填写组合的商品与规则，JSON 格式" />
        </t-form-item>
        <div class="form-grid">
