  ...
  <div class="page-body">
    <header class="page-header surface-card">
      ...
      <t-space size="small">
        ...
        <t-button theme="primary" @click="router.push('/upstream/providers/create')">
          <template #icon>
      ...
      >
        ...
        <template #action="{ row }">
          <div class="action-cell">
            <t-link theme="primary" hover="color" @click="router.push(`/upstream/providers/${row.id}`)">详情</t-link>
...
defineOptions({ name: 'UpstreamProviders' })
