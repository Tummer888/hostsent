<template>
  ...
  >
    ...
    <div class="switch-container">
      <span v-if="type !== 'password'" class="tip" @click="switchType('password')">{{ t('pages.login.accountLogin') }}</span>
...
const type = ref<'password' | 'qrcode' | 'phone'>('password');
...
const switchType = (val: 'password' | 'qrcode' | 'phone') => {
  type.value = val;
};
