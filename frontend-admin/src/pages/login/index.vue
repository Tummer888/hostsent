...
/* 左：白色品牌区（与表单区以竖向分界线隔开） */
.login-panel--brand {
  position: relative;
  padding: 36px 44px 32px;
  background: #ffffff;
  border-right: 1px solid #eef2f8;
  overflow: visible; /* 允许插画向右出血，盖住分界线 */
  z-index: 2; /* 让出血的插画绘制在表单区之上 */
}
...
/* 插画：绝对定位在品牌区右下，向右出血盖住分界线，形成高级的跨栏效果 */
.brand-illustration {
  position: absolute;
  right: -45px;
  bottom: 120px;
