<template>
  <div class="credential-fields">
    <div class="credential-fields__title">凭证配置</div>
    <t-alert
      v-if="!fields.length"
      theme="info"
      :message="emptyHint"
...
import type { ProviderField } from '@/types/interface'
...
const props = withDefaults(
  ...
  }>(),
  {
    fields: null,
    modelValue: () => ({}),
    emptyHint: '该渠道类型未声明凭证字段，可先创建后补充（凭证整体以 JSON 落库）。',
  },
)
...
function selectOptions(field: ProviderField) {
