    ...
    children: [
      {
        ...
        children: [
          { title: '资源总览', path: '/resource/dashboard' },
          { title: '同步监控', path: '/resource/sync-monitor' },
        ],
      },
      {
        title: '上游对接管理',
        ...
        children: [
          { title: '上游提供商', path: '/resource/providers' },
          { title: '资源池管理', path: '/resource/pools' },
          { title: '连接测试', path: '/resource/connectivity' },
        ],
      },
      {
        title: '资源同步与对账',
        ...
        children: [
          { title: '同步任务', path: '/resource/sync' },
          { title: '同步日志', path: '/resource/logs' },
          { title: '对账报告', path: '/resource/reconciliation' },
        ],
      },
      {
        title: '资源商品管理',
        ...
        children: [
          { title: '商品列表', path: '/resource/products' },
          { title: '商品同步', path: '/resource/product-sync' },
          { title: '定价管理', path: '/resource/pricing' },
        ],
      },
      {
        title: '实例资源',
        path: '/resource/instance',
        children: [{ title: '云主机实例', path: '/resource/instances' }],
      },
      {
        title: '运维工具',
        path: '/resource/ops',
        children: [
          { title: 'API测试', path: '/resource/api-test' },
          { title: '异常处理', path: '/resource/anomalies' },
          { title: '系统配置', path: '/resource/settings' },
        ],
      },
    ],
  },
