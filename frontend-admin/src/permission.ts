    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: '验证码配置', path: '/system/captcha', icon: iconWrapper(SecuredIcon) },
        ],
      },
      {
        title: '安全审计',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: iconWrapper(LinkIcon),
        children: [{ title: '渠道配置', path: '/notification/channels', icon: iconWrapper(LinkIcon) }],
      },
      {
        title: '短信模板',
        path: '/notification/sms-templates',
        icon: iconWrapper(SettingIcon),
        children: [{ title: '短信模板', path: '/notification/sms-templates', icon: iconWrapper(SettingIcon) }],
      },
      {
        title: '消息群发',
        path: '/notification/broadcast',
        icon: iconWrapper(SendIcon),
        children: [{ title: '消息群发', path: '/notification/broadcast', icon: iconWrapper(SendIcon) }],
      },
      {
        title: '发送日志',
        path: '/notification/deliveries',
        icon: iconWrapper(RootListIcon),
        children: [{ title: '发送日志', path: '/notification/deliveries', icon: iconWrapper(RootListIcon) }],
      },
    ],
  },
]
