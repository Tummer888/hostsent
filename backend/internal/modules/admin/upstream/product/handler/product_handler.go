...
import (
	...
	"hostsent/backend/internal/modules/admin/upstream/product/service"
...
// @Router /api/v1/admin/upstream/products [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/products/{id} [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/products/{id}/price [put]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/products/sync [post]
