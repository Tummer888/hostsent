...
import (
	...
	"hostsent/backend/internal/modules/admin/upstream/sync/dto"
	"hostsent/backend/internal/modules/admin/upstream/sync/service"
...
// @Router /api/v1/admin/upstream/sync/tasks [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/sync [post]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/sync/tasks/{id} [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/sync/logs [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/instances [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/instances/{id} [get]
