...
import (
	...
	"hostsent/backend/internal/modules/admin/upstream/provider/repository"
...
func (s *providerService) buildProviderInfo(item model.UpstreamProvider) dto.ProviderInfo {
...
func (s *providerService) buildProviderConfig(item *model.UpstreamProvider) *upstream.ProviderConfig {
