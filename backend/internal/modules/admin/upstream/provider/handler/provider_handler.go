...
import (
	...
	"hostsent/backend/internal/modules/admin/upstream/provider/service"
...
// @Router /api/v1/admin/upstream/providers [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/providers [post]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/providers/{id} [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/providers/{id} [put]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/providers/{id} [delete]
...
// @Tags 资源管理-上游提供商
// @Success 200 {object} response.Body
// @Router /api/v1/admin/upstream/providers/types [get]
...
// @Param id path int true "提供商 ID"
// @Success 200 {object} response.Body
// @Router /api/v1/admin/upstream/providers/{id}/test [post]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/pools [get]
...
// @Success 200 {object} response.Body
// @Failure 500 {object} response.Body
// @Router /api/v1/admin/upstream/pools/{id} [get]
