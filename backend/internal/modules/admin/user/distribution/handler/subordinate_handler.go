...
// @Router /api/v1/admin/distribution/subordinates [get]
...
// @Router /api/v1/admin/distribution/subordinates/{id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.SubordinateInfo]
// @Router /api/v1/admin/distribution/subordinates [post]
...
// @Success 200 {object} dto.APIResponse[dto.SubordinateInfo]
// @Router /api/v1/admin/distribution/subordinates/{id} [put]
...
// @Router /api/v1/admin/distribution/subordinates/{id} [delete]
