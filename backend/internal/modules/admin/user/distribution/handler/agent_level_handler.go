...
// @Router /api/v1/admin/distribution/agent-levels [get]
...
// @Router /api/v1/admin/distribution/agent-levels/{id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.AgentLevelInfo]
// @Router /api/v1/admin/distribution/agent-levels [post]
...
// @Success 200 {object} dto.APIResponse[dto.AgentLevelInfo]
// @Router /api/v1/admin/distribution/agent-levels/{id} [put]
...
// @Router /api/v1/admin/distribution/agent-levels/{id} [delete]
