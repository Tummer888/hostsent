...
import (
	...
	"hostsent/backend/internal/modules/admin/user/distribution/dto"
	"hostsent/backend/internal/modules/admin/user/distribution/service"
)
...
// @Router /api/v1/admin/distribution/settlements [get]
...
// @Router /api/v1/admin/distribution/settlements/{id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.SettlementInfo]
// @Router /api/v1/admin/distribution/settlements [post]
...
// @Success 200 {object} dto.APIResponse[dto.SettlementInfo]
// @Router /api/v1/admin/distribution/settlements/{id} [put]
...
// @Success 200 {object} dto.APIResponse[dto.SettlementInfo]
// @Router /api/v1/admin/distribution/settlements/{id}/confirm [post]
...
// @Param request body dto.SettlementStatusChangeRequest true "操作原因"
// @Success 200 {object} dto.APIResponse[dto.SettlementInfo]
// @Router /api/v1/admin/distribution/settlements/{id}/pay [post]
...
// @Success 200 {object} dto.APIResponse[dto.SettlementInfo]
// @Router /api/v1/admin/distribution/settlements/{id}/cancel [post]
...
// @Router /api/v1/admin/distribution/settlements/{id} [delete]
