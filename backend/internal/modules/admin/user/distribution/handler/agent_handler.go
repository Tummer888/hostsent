...
// @Router /api/v1/admin/distribution/agents [get]
...
// @Router /api/v1/admin/distribution/agents/{id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.AgentInfo]
// @Router /api/v1/admin/distribution/agents [post]
...
// @Success 200 {object} dto.APIResponse[dto.AgentInfo]
// @Router /api/v1/admin/distribution/agents/{id} [put]
...
// @Router /api/v1/admin/distribution/agents/{id} [delete]
