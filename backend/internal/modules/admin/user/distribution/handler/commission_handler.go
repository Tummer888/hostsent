...
// @Router /api/v1/admin/distribution/commissions/{id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.CommissionInfo]
// @Router /api/v1/admin/distribution/commissions [post]
...
// @Success 200 {object} dto.APIResponse[dto.CommissionInfo]
// @Router /api/v1/admin/distribution/commissions/{id} [put]
...
// @Success 200 {object} dto.APIResponse[dto.CommissionInfo]
// @Router /api/v1/admin/distribution/commissions/{id}/freeze [post]
...
// @Param request body dto.CommissionStatusChangeRequest true "操作原因"
// @Success 200 {object} dto.APIResponse[dto.CommissionInfo]
// @Router /api/v1/admin/distribution/commissions/{id}/unfreeze [post]
...
// @Success 200 {object} dto.APIResponse[dto.CommissionInfo]
// @Router /api/v1/admin/distribution/commissions/{id}/cancel [post]
...
// @Router /api/v1/admin/distribution/commissions/{id} [delete]
