...
import (
	...
	"hostsent/backend/internal/modules/admin/user/quota/dto"
	"hostsent/backend/internal/modules/admin/user/quota/service"
)
...
// @Router /api/v1/admin/quotas/{id} [get]
...
// @Success 200 {object} dto.APIResponse[[]dto.QuotaInfo]
// @Router /api/v1/admin/quotas/users/{user_id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.QuotaInfo]
// @Router /api/v1/admin/quotas/{id}/adjust [post]
...
// @Router /api/v1/admin/quota-templates [get]
...
// @Router /api/v1/admin/quota-templates/{id} [get]
...
// @Success 200 {object} dto.APIResponse[dto.QuotaTemplateInfo]
// @Router /api/v1/admin/quota-templates [post]
...
// @Success 200 {object} dto.APIResponse[dto.QuotaTemplateInfo]
// @Router /api/v1/admin/quota-templates/{id} [put]
...
// @Router /api/v1/admin/quota-templates/{id} [delete]
...
// @Success 200 {object} dto.APIResponse[dto.UserLevelInfo]
// @Router /api/v1/admin/user-levels/{id}/bind-template [post]
...
// @Router /api/v1/admin/quota-adjustments [get]
...
// @Router /api/v1/admin/quota-adjustments/{id} [get]
