...
func writeError(err error) *apperrors.AppError {
	...
	case errors.Is(err, service.ErrWithdrawStatus):
		return apperrors.New(20003, err.Error())
	case errors.Is(err, service.ErrReferralDisabled):
		return apperrors.New(20003, err.Error())
	case errors.Is(err, service.ErrInvalidAmount), errors.Is(err, service.ErrBelowMinWithdraw):
