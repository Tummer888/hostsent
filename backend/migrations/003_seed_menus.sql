...
(25, 24, 'admin', '用户资源配额',          'menu',      '/users/quota/resources',          'users/quota/resources/index',     'chart-bubble',    1, 'active'),
(26, 24, 'admin', '配额模板管理',          'menu',      '/users/quota/templates',          'users/quota/templates/index',     'catalog',         2, 'active'),
(27, 24, 'admin', '用户等级管理',          'menu',      '/users/quota/tiers',              'users/quota/tiers/index',         'tag',             3, 'active'),
(28, 24, 'admin', '配额调整记录',          'menu',      '/users/quota/changes',            'users/quota/changes/index',       'history',         4, 'active'),
-- 2.7 实名认证
(29, 4,  'admin', '实名认证',             'directory', '/users/verification',            NULL,                              'verify',          7, 'active'),
(30, 29, 'admin', '待审核列表',           'menu',      '/users/verification/pending',     'users/verification/pending/index', 'history',         1, 'active'),
(31, 29, 'admin', '审核通过列表',         'menu',      '/users/verification/approved',   'users/verification/approved/index','check-circle',    2, 'active'),
(32, 29, 'admin', '审核拒绝列表',         'menu',      '/users/verification/rejected',   'users/verification/rejected/index','error-circle',    3, 'active'),
(33, 29, 'admin', '认证配置',             'menu',      '/users/verification/config',     'users/verification/config/index', 'setting',         4, 'active'),
-- 3. 资源管理
(34, 0,  'admin', '资源管理', 'directory', '/resources',                     NULL,                            'layers',     3, 'active'),
